import { Player, PlayerT, fieldValueToPlayer, nextPlayer, FieldValueT, FieldValue, Game } from '../../components/ticTacToeTypes';
...
export function getCurrentField(game: Game): FieldValueT[][] {
    ...
    for (let i = 0; i < game.nextTurnIndex; i++) {
        ...
        startField[turn.y_coord][turn.x_coord] = turn.turn;
    }
    return startField;
}
